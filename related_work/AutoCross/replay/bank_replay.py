...
features = [['duration__2', 'pdays'], ['age', 'pdays'], ['default', 'duration__1'], ['marital', 'contact'], ['job', 'duration__1'], ['pdays', 'duration__1', 'default'], ['education', 'default'], ['contact', 'pdays'], ['loan', 'campaign'], ['job', 'pdays'], ['marital', 'pdays'], ['marital', 'housing'], ['housing', 'loan'], ['housing', 'contact']]
