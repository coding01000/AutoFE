...
from related_work.RL_AAAI_2018.env.BikeShareEnv import BikeShareEnv
...
if __name__ == "__main__":
    ...
    agent = DQNAgent(env, memory_size, batch_size, target_update, epsilon_decay, load_name)
